###########################################################################
## Makefile generated for Simulink model 'BremsenZeitvarianzTest_MDL'. 
## 
## Makefile     : BremsenZeitvarianzTest_MDL.mk
## Generated on : Thu Jul 20 09:26:09 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BremsenZeitvarianzTest_MDL.elf
...
PRODUCT_NAME              = BremsenZeitvarianzTest_MDL
MAKEFILE                  = BremsenZeitvarianzTest_MDL.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ich/Desktop/CubeJump
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = BremsenZeitvarianzTest_MDL_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BremsenZeitvarianzTest_MDL.elf
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/BremsenZeitvarianzTest_MDL_ert_rtw -I$(START_DIR) -I$(START_DIR)/workspace/BremsenZeitvarianzTest -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/include -IC:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/lib -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=BremsenZeitvarianzTest_MDL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=BremsenZeitvarianzTest_MDL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.c.o : $(START_DIR)/BremsenZeitvarianzTest_MDL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/BremsenZeitvarianzTest_MDL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/BremsenZeitvarianzTest_MDL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
