###########################################################################
## Makefile generated for Simulink model 'ADCCalibration_MDL'. 
## 
## Makefile     : ADCCalibration_MDL.mk
## Generated on : Wed Jul 19 13:25:47 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ADCCalibration_MDL.elf
...
PRODUCT_NAME              = ADCCalibration_MDL
MAKEFILE                  = ADCCalibration_MDL.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ich/Desktop/CubeJump/workspace/ADCCalibration
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ADCCalibration_MDL_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ADCCalibration_MDL.elf
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/ADCCalibration_MDL_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/include -IC:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/lib -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=ADCCalibration_MDL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.c.o : $(START_DIR)/ADCCalibration_MDL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/ADCCalibration_MDL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/ADCCalibration_MDL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
