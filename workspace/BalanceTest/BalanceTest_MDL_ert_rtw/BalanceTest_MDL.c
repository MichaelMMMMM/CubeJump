...
void BalanceTest_MDL_initialize(void)
{
  ...
  /* External mode info */
  BalanceTest_MDL_M->Sizes.checksums[0] = (2216433885U);
  BalanceTest_MDL_M->Sizes.checksums[1] = (2123113358U);
  BalanceTest_MDL_M->Sizes.checksums[2] = (3514567275U);
  BalanceTest_MDL_M->Sizes.checksums[3] = (604336625U);
