...
void BremsenZeitvarianzTest_MDL_initialize(void)
{
  ...
  /* External mode info */
  BremsenZeitvarianzTest_MDL_M->Sizes.checksums[0] = (601849471U);
  BremsenZeitvarianzTest_MDL_M->Sizes.checksums[1] = (934568470U);
  BremsenZeitvarianzTest_MDL_M->Sizes.checksums[2] = (2096897432U);
  BremsenZeitvarianzTest_MDL_M->Sizes.checksums[3] = (2198675591U);
