###########################################################################
## Makefile generated for Simulink model 'JumpTest_MDL'. 
## 
## Makefile     : JumpTest_MDL.mk
## Generated on : Mon Jul 24 09:24:38 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/JumpTest_MDL.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ich/Desktop/CubeJump/workspace/JumpTest
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = JumpTest_MDL_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/JumpTest_MDL.elf
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/JumpTest_MDL_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/include -IC:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/lib -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=JumpTest_MDL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=JumpTest_MDL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = JumpTest_MDL.c.o JumpTest_MDL_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o Assertion.pp.o CPWM.pp.o CGPIO.pp.o CADC.pp.o CBrake.pp.o CMotor.pp.o CMPU6050.pp.o MS_Cube_ADC_Wrapper.pp.o MS_Cube_Motor_Wrapper.pp.o MS_Cube_Sensors_Wrapper.pp.o MS_Cube_Brake_Wrapper.pp.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/JumpTest_MDL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/JumpTest_MDL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/JumpTest_MDL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : C:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/MS_Cube_Brake/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : C:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/MS_Cube_Brake/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : C:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/MS_Cube_Brake/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
CPWM.pp.o : C:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/lib/CPWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CGPIO.pp.o : C:/Users/ich/Desktop/SimulinkCodeGeneration/workspace/EmbeddedCoderTarget/MS_Cube_Blockset/lib/CGPIO.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
